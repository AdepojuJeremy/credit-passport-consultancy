  ...
  return (
    <header className="sticky top-0 z-50 border-b hairline bg-[color:var(--background)]/92 backdrop-blur-xl">
      <div className="site-container flex h-16 items-center justify-between gap-8">
        <Link href="/" aria-label="CreditPassport Consulting home">
          <BrandLockup />
        </Link>
        ...
        <Link
          href="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-[color:var(--foreground)] px-4 py-2 text-sm text-white transition-colors duration-150 hover:bg-[color:var(--brand-blue)]"
        >
